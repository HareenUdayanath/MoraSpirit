                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action={{route('addAchievement')}}>
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-9">
                                <input type="text"   id="index-number" name="index-number" required="required" class="form-control col-md-7 col-xs-12" maxlength="1">

                            </div>
                                <div class="col-md-3 col-sm-3 col-xs-3">
                            <button type="button" class="btn btn-success " onclick="loadTable()">Go</button>
                                </div>
                            <script type="text/javascript">
                                function loadTable(){
                                    ...
                                    $.ajax({
                                        ...
                                        url: '{{url('getAchList')}}/' + ID,
                                        success: function (data) {
                                            if (data == 1) {

                                            } else {
                                                $("#achieveTable").html(data).show();
